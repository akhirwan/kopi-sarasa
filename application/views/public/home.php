...
<main>
        ...
        <nav>
            <ul>
                ...
                <?php foreach($categories as $cat){ 
                    echo '<li class="tm-paging-item"><a href="#" class="tm-paging-link">' . $cat->name . '</a></li>';
                 } ?>
            </ul>
        </nav>
    </div>
    ...
    <div class="row tm-gallery">
        <!-- <?php //foreach($categories as $cat){?>
            <div id="tm-gallery-page-<?php //echo strtolower($cat->name);?>" class="tm-gallery-page">
            <?php //foreach($items as $item){
                //if($item->category == $cat->id){?>
                <figure>
                    <img src="<?php //echo base_url('assets/public/img/items/'.$item->picture)?>" width="250" alt="Image" class="img-fluid tm-gallery-img" />
                    <figcaption>
                        <h4 class="tm-gallery-title"><?php //echo $item->name;?></h4>
                        <p class="tm-gallery-description"><?php //echo $item->description;?></p>
                        <p class="tm-gallery-price"><?php //echo $item->price;?></p>
                    </figcaption>
                </figure>
            <?php //}
            //}?>
